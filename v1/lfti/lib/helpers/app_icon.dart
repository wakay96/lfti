...
class AppIcon {
  ...
  static const activeWorkout = FaIcon(FontAwesomeIcons.running);

  static const inactiveWorkout = FaIcon(FontAwesomeIcons.dumbbell);

  static const previousWorkout = FaIcon(FontAwesomeIcons.walking);

  static const rest = FaIcon(FontAwesomeIcons.bed);

  static const inactiveDashboard = FaIcon(FontAwesomeIcons.home);

  static const activeDashboard = FaIcon(FontAwesomeIcons.home);
}
