...
import 'package:lfti_api/src/routines/local_storage_routines_api.dart';
...
import 'local_storage_routines_api_test.mocks.dart';

@GenerateNiceMocks([MockSpec<RoutinesApi>()])
void main() {
  setUpAll(() {
    Get.put(MockRoutinesApi());
  });
